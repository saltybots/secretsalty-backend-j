...
public class GroupRecord extends UpdatableRecordImpl<GroupRecord> {
     ...
     */
    public GroupRecord(UUID uuid, String name, LocalDateTime created, LocalDateTime lastModified, String invite, Long status, UUID adminId, Float budget, String description, LocalDate selectionDate, Boolean reminder, Long unlikelyCount) {
        super(Group.GROUP);
